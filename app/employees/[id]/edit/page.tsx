...
export default async function EditEmployeePage({
  ...
  // Capturamos TODO dentro de un try/catch para que NADA rompa el render.
  try {
    ...
    if (empErr) {
      // Mostramos el error pero no rompemos
      return (
          ...
          <Card className="shadow-clientum mt-6">
            <CardContent className="p-6">
              <p className="text-sm text-red-600">
                Error cargando empleado: {empErr.message}
              </p>
            </CardContent>
          </Card>
        </main>
    ...
    // 2) Departamentos (si falla, devolvemos lista vacía)
    ...
    // Si algo explota fuera de las consultas (por import/JS), devolvemos UI en vez de lanzar.
    return (
      <main className="max-w-6xl mx-auto p-4 md:p-6">
        <BackButton />
        <h1 className="text-2xl md:text-3xl font-semibold text-slate-900 mt-2">
